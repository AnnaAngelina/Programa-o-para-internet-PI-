...
SECRET_KEY = 'django-insecure-wys+a4@t#u@$%t_lqi@_=*p6^kqp85v1nb0gbbtlohk+qogqc#'
...
TEMPLATES = [
    {
        ...
        'DIRS': [BASE_DIR / 'mercado/templates'],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
print(f"TEMPLATES DIR: {BASE_DIR / 'mercado/templates'}")
